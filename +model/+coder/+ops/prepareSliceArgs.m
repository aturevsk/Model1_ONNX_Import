...
Starts = model.coder.ops.extractIfDlarray(Starts_);
Ends = model.coder.ops.extractIfDlarray(Ends_);
Axes_ = model.coder.ops.extractIfDlarray(Axes__);
Steps_ = model.coder.ops.extractIfDlarray(Steps__);
